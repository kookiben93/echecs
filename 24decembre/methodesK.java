...
public class methodes {
    ...
    public static void roque(int[][] plateau, int Roi, int ligne, int colonne, int nbMouvementR, int nbMouvementT){
        int Tour;
        ...
        if(nbMouvementT==0 && plateau[ligne][colonne+1]==0 && plateau[ligne][colonne+2]==0){
            plateau[ligne][colonne] = 0;
            plateau[ligne][colonne+2] = Roi;
            plateau[ligne][colonne+3] = 0;
            plateau[ligne][colonne+1] = Tour;
        }
        else if(nbMouvementT==0 && plateau[ligne][colonne-1]==0 && plateau[ligne][colonne-2]==0 && plateau[ligne][colonne-3]==0){
            plateau[ligne][colonne] = 0;
