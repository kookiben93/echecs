...
public class pieces {
    ...
    public static void tour(int[][] plateau, int ligne, int colonne, int mode) {
        ...
        if ((haut && !gauche && !droite && !bas) || direction == 1) {           //aller en haut
            ...
            while (!(methodes3.caseValide(ligne-choix, colonne)) || methodes3.empechement(plateau, ligne, colonne, choix, 1) || methodes3.memeCouleur(plateau, ligne-choix, colonne, couleur)) {
            ...
            while (!(methodes3.caseValide(ligne, colonne-choix)) || methodes3.empechement(plateau, ligne, colonne, choix, 2) || methodes3.memeCouleur(plateau, ligne, colonne-choix, couleur)) {
                System.out.println("impossible d'avancer jusque là");
                System.out.print("de combien veux-tu avancer ? : ");
                choix = Integer.parseInt(sc.nextLine());
            }
            ...
            while (!(methodes3.caseValide(ligne, colonne + choix)) || methodes3.empechement(plateau, ligne, colonne, choix, 3) || methodes3.memeCouleur(plateau, ligne, colonne + choix, couleur)) {
                System.out.println("impossible d'avancer jusque là");
                System.out.print("de combien veux-tu avancer ? : ");
                choix = Integer.parseInt(sc.nextLine());
            }
            ...
            while (!(methodes3.caseValide(ligne + choix, colonne)) || methodes3.empechement(plateau, ligne, colonne, choix, 4) || methodes3.memeCouleur(plateau, ligne + choix, colonne, couleur)) {
                System.out.println("impossible d'avancer jusque là");
                System.out.print("de combien veux-tu avancer ? : ");
                choix = Integer.parseInt(sc.nextLine());
            }
