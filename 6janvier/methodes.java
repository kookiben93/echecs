...
public class methodes {
    ...
    //dans la situation où il est employé (pour le mode moyen et le mode robot)
    public static boolean pepRobot(int[][] plateau, int ligne, int colonne, int nvLigne, int nvColonne, int pion){
        ...
        if(pepPossibleGauche(plateau, ligne, colonne, pion)) {      //si la prise en passant vers la gauche est possible

            if (pion == 12 && nvLigne == ligne-1 && nvColonne == colonne-1) {       //le mouvement ligne-1 (haut) et colonne-1 (gauche) est
                mouvementValide = true;                                             //possible pour les pions bleus
            }
            else if (pion == 6 && nvLigne == ligne+1 && nvColonne == colonne-1){      //le mouvement ligne+1 (bas) et colonne-1 (gauche) est
                mouvementValide = true;                                               //possible pour les pions jaunes
            }

        } else if(pepPossibleDroite(plateau, ligne, colonne, pion)){       //si la prise en passant vers la droite est possible

            if (pion == 12 && nvLigne == ligne-1 && nvColonne == colonne+1) {   //le mouvement ligne-1 (haut) et colonne+1 (droite) est
                mouvementValide = true;                                         //possible pour les pions bleus
            }
            else if (pion == 6 && nvLigne == ligne+1 && nvColonne == colonne+1){      //le mouvement ligne-1 (haut) et colonne+1 (droite) est
                mouvementValide = true;                                                 //possible pour les pions bleus
            }
        }
    ...
    public static void robotChoix(int[][] plateau, char joueur) {
        ...
        do {
            ...
            if (plateau[ligne][colonne] == 7 || plateau[ligne][colonne] == 1) {             //tours
                ...
                mouvement = mouvementPionRobot(plateau, ligne, colonne, nvLigne, nvColonne, piece) || pepRobot(plateau, ligne, colonne, nvLigne, nvColonne, piece);
            ...
            //refais la boucle tant que la case choisit est invalide, est occupé par une pièce de meme couleur ou que le
            //mouvement de la pièce est invalide
    ...
    //Convertit un type String pris en paramètre en un int spécifique
    //pour le choix de colonne
