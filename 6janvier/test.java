...
class MethodesTest {
    ...
    void testMouvementTour() {
        ...
        assertTrue(methodes.mouvementTour(plateau, 3, 2, 3, 5), "cas mouvement horizontal");
        assertTrue(methodes.mouvementTour(plateau, 3, 2, 6, 2), "cas mouvement vertical");
        assertFalse(methodes.mouvementTour(plateau, 3, 2, 3, 2), " cas aucun mouvement");
    }
