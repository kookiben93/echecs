    ...
    static void main(String[] args) {
        ...
        while (choix == 2) {
            ...
            System.out.println("\uD83C\uDFC1 Fin de partie\n" + "-La partie se termine par :\n" + "-échec et mat\n" + "-abandon\n" +
                    "-pat (nul)\n" + "-plus de matériel suffisant pour mater : roi contre roi ou roi+fou contre roi ou roi+cavalier" +
                    "contre roi ou roi+fou contre roi+fou de mêmes couleurs");
            System.out.println("---------------------------------------------------------------------------------------");
            System.out.println();
            choix = methodes.debut(choix);
        ...
        if (choix == 3) {
            ...
            do {
                System.out.print("Voulez-vous jouer en 2v2 (1) contre le robot (2) ? : ");
            ...
            while (tour < 100 && !abandonJoueur && !methodes.MaterielInsuffisant(plateau)) {
                if (bleu.equals("oui")) {
                    if (tour % 2 == 0) {
