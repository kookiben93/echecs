...
public class methodes {
    ...
    public static void robotChoix(int[][] plateau, char joueur) {
        ...
        AffichageSituation(couleur, li, col, ligne, colonne, -1, -1);
        plateau[li][col]=0;
    ...
    public static void mouvementPion(int[][] plateau, int ligne, int colonne, int pion) {
        ...
        boolean priseEnPassantG = methodes.pepPossibleGauche(plateau, ligne, colonne, pion);
        boolean priseEnPassantD = methodes.pepPossibleDroite(plateau, ligne, colonne, pion);
            ...
            do {
                ...
                if (caseValide(nvLigne, nvColonne)) {
                    ...
                    if (distC == 0 && distL == 1 && plateau[nvLigne][nvColonne] == 0) {
                        ...
                        System.out.println("\uD83C\uDF1F " + "Le pion " + couleur + " s'est déplacé de la case (" + (ligne + 1) + "," + conversionEnString(colonne) + ") vers la case (" + (nvLigne + 1) + "," + conversionEnString(nvColonne) + ")");
                    }
                    ...
                    // Manger en diagonale
                    else if (distC == 1 && distL == 1 && plateau[nvLigne][nvColonne] != 0 && !memeCouleur(plateau, nvLigne, nvColonne, pion)) {
                        mouvementValide = true;
    ...
    public static void mouvementRoi(int[][] plateau, int ligne, int colonne, int piece) {
        Scanner sc = new Scanner(System.in);
        ...
        System.out.println("\uD83C\uDF1F " + "Le roi " + couleur + " s'est déplacé de la case (" + (ligne + 1) + "," + conversionEnString(colonne) + ") vers la case (" + (nvLigne + 1) + "," + conversionEnString(nvColonne) + ")");
    }
    ...
    public static void BougePion(int[][] plateau, int ligne, int colonne, char joueur, int pion) {
        ...
        if (reponse == 1){
            ...
            if (ligne == ligneFin) {
                ...
                AffichageSituation(pion, ligne, colonne, NvLigne, NvColonne, avancer, 0);
                plateau[NvLigne][NvColonne] = pion;
            }
        }
    }
    ...
    public static void BougeRoi(int[][] plateau, int ligne, int colonne, char joueur, int couleur, int mvtTourLoin, int mvtTourProche, int mvtRoi){
        ...
        boolean grand = GrandRoque(plateau, ligne, colonne, TourLointaine);
